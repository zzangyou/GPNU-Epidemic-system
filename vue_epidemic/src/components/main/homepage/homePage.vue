    ...
    <div>
        <div class="row">
            <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box" style="background-color:rgb(212 150 152);color:#fff">
                    <div class="inner">
            ...
            <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box" style="background-color: #7b8b6f;color:#fff">
                    <div class="inner">
                        <h3 v-text="fill"></h3>
                        <p>已填报人数</p>
                    </div>
            ...
            <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box" style="background-color:#d75454;color:#fff">
                    <div class="inner">
                        <h3 v-text="hotTmp"></h3>
                        <p>今日高危人数</p>
                    </div>
            ...
            <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box" style="background-color:#efd072">
                    <div class="inner">
