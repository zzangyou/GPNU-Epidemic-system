...
module.exports = class student_dao extends require('../model/student_mod') {
    ...
    static async sethealth(req, resp) {
        ...
        let hot = body.hot
        let goother = body.goother
        let otheradd = body.otheradd
        ...
        let u_id = verify.id
        let data = await this.sethealthMod(u_id, temperature, hot, goother, otheradd, fever, leave, hesuan, mask, masknum, kill)
        resp.send(data)
    }
